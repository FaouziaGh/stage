...
Scenario Outline: Add a Periode with valid data
    And User fills the form with the following data "P31", "10/10/2026", "30/12/2026" and clicks on save button
...
Scenario Outline: Add a Periode with invalid data
 ...
 Scenario Outline: Add a Periode with empty fields
  ...
  Scenario Outline: Add a Periode with an already existing name
   ...
   And User fills the first form with the following data "Périodes_22", "22/09/2026", "30/11/2026"
   When User clicks on "+ajouter plus" button 
   And User fills the second form with the following data "Périodes_33", "01/12/2026", "28/02/2027"
   Then User cliks on "+ajouter plus" button
   And User fills the third form with the following data "Périodes_44", "01/03/2027", "30/06/2027"
  ...
  Scenario: Remove a row added by Ajouter Plus
    And User fills the first form with the following data "Période_55", "22/09/2026", "30/11/2026"
    When User clicks on "+ajouter plus" button 
    And User fills the second form with the following data "Période_71", "01/12/2026", "28/02/2027"
