...
Background:
   ...
   When User searches and clicks on the update icone of the periode "Période26"
   And The update popup that contains the title "Modifier période" is displayed
   Then User update the form with the following data "P_26", "10/10/2026", "30/11/2026" and clicks on update button
