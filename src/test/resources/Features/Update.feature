...
Background:
   ...
   When User searches and clicks on the update icone of the periode "Période33"
   And The update popup that contains the title "Modifier période" is displayed
   Then User update the form with the following data "période_33", "01/10/2026", "30/12/2026" and clicks on update button
   ...
   When User searches and clicks on the update icone of the periode "Période_12"
   And The update popup that contains the title "Modifier période" is displayed
   Then User update the form with the following data "P_12", "01/10/2026", "30/08/2025" and clicks on update button
   ...
   Scenario Outline: Update a Periode with an already existing name
    When User searches and clicks on the update icone of the periode "Périodes_49"
    And The update popup that contains the title "Modifier période" is displayed
    Then User update the form with the following data "Période_70", "15/08/2024", "30/069/2025" and clicks on update button
   ...
   When User searches and clicks on the update icone of the periode "Période de test12"
   And The update popup that contains the title "Modifier période" is displayed
   ...
   Scenario Outline: Update a Periode with invalid Name 
   When User searches and clicks on the update icone of the periode "Période de test6"
   And The update popup that contains the title "Modifier période" is displayed
   ...
   When User searches and clicks on the update icone of the periode "Période15"
   And The update popup that contains the title "Modifier période" is displayed
   Then User cleared each field then clicked on update button
   Then Error messages are displayed under each empty field with data "Période15", "22/09/2026"
   
   #Annule - Update a Periode and then cancel it (update a name)
   Scenario: Update a Periode name and then cancel it
   When User searches and clicks on the update icone of the periode "Période36"
   And The update popup that contains the title "Modifier période" is displayed
