...
public class LoginStepDef {
	...
	public void admin_enter_correct_username_and_correct_password(String uname, String pwd) throws Exception {
	    LoginPage login = new LoginPage();
	    login.connect(uname, pwd);
	}
	
	@Then("admin click on role {string}")
	public void admin_click_on_role(String roleName) throws Exception {
		LoginPage login = new LoginPage();
